...
const BINDINGS_PATH = join(__dirname, "..", "managed", "RevocationRegistry", "contract", "index.js");
const HAS_COMPILED_ARTIFACTS = existsSync(BINDINGS_PATH);

describe("RevocationRegistry.compact Circuit Tests", () => {
  ...
  it("exports RevocationRegistry contract and methods", async () => {
