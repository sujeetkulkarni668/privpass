...
(function (CredentialType) {
  CredentialType[CredentialType['PAN'] = 0] = 'PAN';
  CredentialType[CredentialType['AADHAAR'] = 1] = 'AADHAAR';
  CredentialType[CredentialType['AGE'] = 2] = 'AGE';
  CredentialType[CredentialType['RESIDENCY'] = 3] = 'RESIDENCY';
  CredentialType[CredentialType['IDENTITY_COMPOSITE'] = 4] = 'IDENTITY_COMPOSITE';
})(CredentialType || (CredentialType = {}));

export var CredentialStatus;
(function (CredentialStatus) {
  CredentialStatus[CredentialStatus['ISSUED'] = 0] = 'ISSUED';
  CredentialStatus[CredentialStatus['ACTIVE'] = 1] = 'ACTIVE';
...
class _CredentialRecord_0 {
  alignment() {
    return _descriptor_0.alignment().concat(_descriptor_1.alignment().concat(_descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_2.alignment().concat(_descriptor_3.alignment())))));
  }
  fromValue(value_0) {
    return {
      commitment: _descriptor_0.fromValue(value_0),
      credentialType: _descriptor_1.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.commitment).concat(_descriptor_1.toValue(value_0.credentialType).concat(_descriptor_0.toValue(value_0.issuer).concat(_descriptor_2.toValue(value_0.issuedAt).concat(_descriptor_2.toValue(value_0.expiresAt).concat(_descriptor_3.toValue(value_0.status))))));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.issuerSalt) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named issuerSalt');
    }
    ...
    this.circuits = {
      authorizeIssuer: (...args_1) => {
        ...
        const issuerIdentity_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('authorizeIssuer',
                                     'argument 1 (as invoked from Typescript)',
                                     'CredentialRegistry.compact line 14 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(issuerIdentity_0.buffer instanceof ArrayBuffer && issuerIdentity_0.BYTES_PER_ELEMENT === 1 && issuerIdentity_0.length === 32)) {
          __compactRuntime.typeError('authorizeIssuer',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(issuerIdentity_0),
      ...
      registerCredential: (...args_1) => {
        if (args_1.length !== 6) {
          throw new __compactRuntime.CompactError(`registerCredential: expected 6 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const commitment_0 = args_1[1];
        const credentialType_0 = args_1[2];
        const issuer_0 = args_1[3];
        const issuedAt_0 = args_1[4];
        const expiresAt_0 = args_1[5];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerCredential',
                                     'argument 1 (as invoked from Typescript)',
                                     'CredentialRegistry.compact line 44 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        if (!(typeof(credentialType_0) === 'number' && credentialType_0 >= 0 && credentialType_0 <= 4)) {
          __compactRuntime.typeError('registerCredential',
                                     'argument 2 (argument 3 as invoked from Typescript)',
                                     'CredentialRegistry.compact line 44 char 1',
                                     'Enum<CredentialType, PAN, AADHAAR, AGE, RESIDENCY, IDENTITY_COMPOSITE>',
                                     credentialType_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(commitment_0).concat(_descriptor_1.toValue(credentialType_0).concat(_descriptor_0.toValue(issuer_0).concat(_descriptor_2.toValue(issuedAt_0).concat(_descriptor_2.toValue(expiresAt_0))))),
            alignment: _descriptor_0.alignment().concat(_descriptor_1.alignment().concat(_descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_2.alignment()))))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      revokeCredential: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('revokeCredential',
                                     'argument 1 (as invoked from Typescript)',
                                     'CredentialRegistry.compact line 75 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(commitment_0.buffer instanceof ArrayBuffer && commitment_0.BYTES_PER_ELEMENT === 1 && commitment_0.length === 32)) {
      ...
      statusOf: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`statusOf: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const commitment_0 = args_1[1];
        const now_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('statusOf',
                                     'argument 1 (as invoked from Typescript)',
                                     'CredentialRegistry.compact line 96 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(commitment_0.buffer instanceof ArrayBuffer && commitment_0.BYTES_PER_ELEMENT === 1 && commitment_0.length === 32)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(commitment_0).concat(_descriptor_2.toValue(now_0)),
        ...
        const result_0 = this._statusOf_0(context,
                                          partialProofData,
                                          commitment_0,
                                          now_0);
    ...
    this.impureCircuits = {
      ...
      statusOf: this.circuits.statusOf
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('statusOf', new __compactRuntime.ContractOperation());
  ...
  _issuerSecret_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('issuerSecret',
                                 'return value',
                                 'CredentialRegistry.compact line 5 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _issuerSalt_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.issuerSalt(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('issuerSalt',
                                 'return value',
                                 'CredentialRegistry.compact line 6 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _authorityId_0(secret_0, salt_0) {
    return this._persistentHash_0([secret_0, salt_0]);
  }
  _authorizeIssuer_0(context, partialProofData, issuerIdentity_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(issuerIdentity_0),
  ...
  _registerCredential_0(context,
                        ...
                        expiresAt_0)
  {
    const discCommitment_0 = commitment_0;
    const discIssuer_0 = issuer_0;
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_10.toValue(1n),
                                                                                                                   alignment: _descriptor_10.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(discCommitment_0),
                                                                                                                                               alignment: _descriptor_0.alignment() }).encode() } },
                                                                                        'member',
                                                                                        { popeq: { cached: true,
    ...
    const callerIssuerId_0 = this._authorityId_0(this._issuerSecret_0(context,
                                                                      partialProofData),
                                                 this._issuerSalt_0(context,
                                                                    partialProofData));
    __compactRuntime.assert(this._equal_0(callerIssuerId_0, issuer_0),
                            'caller is not the stated issuer');
    __compactRuntime.assert(_descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_10.toValue(0n),
                                                                                                                  alignment: _descriptor_10.alignment() } }] } },
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(discIssuer_0),
                                                                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                                                                       'member',
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value)
                            ...
                            _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { idx: { cached: false,
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_0.toValue(discIssuer_0),
                                                                                                                  alignment: _descriptor_0.alignment() } }] } },
                                                                                       { popeq: { cached: false,
                                                                                                  result: undefined } }]).value),
                            'issuer not authorized');
    const record_0 = { commitment: discCommitment_0,
    ...
    const record_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               ...
                                                                               [
                                                                                ...
                                                                                { idx: { cached: false,
                                                                                         ...
                                                                                         path: [
                                                                                                { tag: 'value',
                                                                                                  value: { value: _descriptor_0.toValue(discCommitment_0),
                                                                                                           alignment: _descriptor_0.alignment() } }] } },
                                                                                { popeq: { cached: false,
                                                                                           result: undefined } }]).value);
    __compactRuntime.assert(record_0.status !== 3, 'already revoked');
    const callerIssuerId_0 = this._authorityId_0(this._issuerSecret_0(context,
                                                                      partialProofData),
                                                 this._issuerSalt_0(context,
                                                                    partialProofData));
    __compactRuntime.assert(this._equal_1(callerIssuerId_0, record_0.issuer),
                            'only the issuing authority may revoke');
    const updated_0 = { commitment: record_0.commitment,
  ...
  _statusOf_0(context, partialProofData, commitment_0, now_0) {
    const discCommitment_0 = commitment_0;
    __compactRuntime.assert(_descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
    ...
    const record_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               ...
                                                                               [
                                                                                ...
                                                                                { popeq: { cached: false,
                                                                                           result: undefined } }]).value);
    const discNow_0 = now_0;
    if (record_0.status === 3) {
      return 3;
    } else {
      if (discNow_0 >= record_0.expiresAt) {
        return 2;
      } else {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'CredentialRegistry.compact line 12 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    credentials: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'CredentialRegistry.compact line 42 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({
  issuerSecret: (...args) => undefined, issuerSalt: (...args) => undefined
});
